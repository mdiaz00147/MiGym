...
<?php 
  ...
  $query="SELECT * FROM panel_reports WHERE `publisher`='$username'";
...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <div class="navbar-header">
		  ...
		  <a href="index.php" class="navbar-brand hidden-lg">MacBeth</a>
		</div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <!-- Logo. -->
          <div class="logo">
            <h1><img src="img/logo.png" width="200px" height="92" ></h1> 
...
<div class="content">
   ...
   <?php include ("sections/menu.php"); ?>
  	...
  	<div class="mainbar">
	    ...
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left"><i class="fa fa-home"></i> OVERVIEW Across all of your sites & placements</h2>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="widget">
                ...
                <div class="widget-head">
                  <div class="pull-left">Yesterday Stats</div>
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
                    <a href="#" class="wclose"><i class="fa fa-times"></i></a>
                  </div>  
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <ul class="current-status">
                      <li>
                        <span id="status1"></span> <span class="bold">Impressions : <?=$impressions?></span>
                      </li>
                      <li>
