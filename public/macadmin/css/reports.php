...
<head>
  ...
  <title>Dymanic Tables - MacAdmin</title>
...
<div class="content">
    ...
    <!-- Sidebar ends -->
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-table"></i> Reports</h2>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Daily Stats</div>
								...
								<div class="table-responsive">
									<table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="100%">
										...
										while ($row = mysql_fetch_object($result)){  
										  ...
										  $impressions2=number_format($impressions);
										  $revenue=$row->revenue;
										  $date=$row->date;
